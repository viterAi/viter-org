...
export type Modality = 'text' | 'voice' | 'image' | 'video' | 'tool_call' | 'file' | 'signal';
...
export type Extractor = (artifact: L0Artifact, run: ExtractionRun, ctx: ExtractorContext) => AsyncIterable<L1EventInsert>;
