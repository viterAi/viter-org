...
// ────────────────────────────────────────────────────────────────────
// Helper: discriminated parsing of webhook payload by event type
// ────────────────────────────────────────────────────────────────────

export type GowaWebhookParsed =
  | { event: 'message'; device_id: string; data: GowaMessageData }
  | { event: 'message.ack'; device_id: string; data: GowaMessageAckData }
  | { event: 'message.reaction'; device_id: string; data: GowaReactionData }
  | { event: 'message.revoke'; device_id: string; data: GowaMessageData }
  | { event: 'message.edited'; device_id: string; data: GowaMessageData }
  | { event: 'device.connection.update'; device_id: string; data: GowaDeviceConnectionData }
  | { event: 'device.disconnected'; device_id: string; data: GowaDeviceConnectionData }
  | { event: 'device.banned'; device_id: string; data: GowaDeviceConnectionData }
  | { event: 'pair.qr.consumed'; device_id: string; data: GowaPairQrData }
  | { event: 'pair.qr.generated'; device_id: string; data: GowaPairQrData }
  | { event: GowaWebhookEventType; device_id: string; data: unknown };

export function parseWebhook(envelope: GowaWebhookEnvelope): GowaWebhookParsed {
